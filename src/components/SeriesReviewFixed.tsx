...
export function SeriesReview() {
    ...
    const handleRetryProcessing = useCallback((pageId: string) => {
        ...
        reader.onloadend = () => {
            ...
            updatePage(pageId, { status: 'pending', error: undefined });
    ...
    const handleNameSubmit = useCallback((e: React.FormEvent<HTMLFormElement>) => {
        ...
        // Small timeout to allow for state updates
        setTimeout(async () => {
            try {
                // Create the complete series object with ID and creation date
                const fullSeries = {
    ...
    }, [setSeriesName, draft, clearDraft, navigate]);
                                ...
                                <div className="sm:flex sm:gap-6">
                                    ...
                                    <div className="sm:w-2/3">
                                        ...
                                        {editingTextId === page.id ? (
                                            ...
                                            <>
                                                {page.meta && page.meta.error ? (
                                                    <div className="bg-red-50 border-l-4 border-red-400 p-3 rounded-md text-sm">
                                                        <div className="flex items-center space-x-2 mb-2">
                                                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-red-500" viewBox="0 0 20 20" fill="currentColor">
                                                                <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
                                                            </svg>
                                                            <h4 className="font-medium">Text Extraction Problem</h4>
                                                        </div>
                                                        <p>The image could not be properly analyzed. This might be due to:</p>
                                                        <ul className="list-disc pl-5 mt-1">
                                                            <li>Low image quality or poor lighting</li>
                                                            <li>Non-text content or unrecognizable text</li>
                                                            <li>Complex formatting that wasn't properly recognized</li>
                                                        </ul>
                                                        <p className="mt-2">Try retaking the photo with better lighting and a clearer view.</p>
                                                    </div>
                                                ) : (
                                                    <div
                                                        className="bg-gray-50 p-3 rounded-md text-sm max-h-48 overflow-y-auto"
                                                        dangerouslySetInnerHTML={{ __html: page.text || '<em>No text extracted</em>' }}
                                                    />
                                                )}
                                            </>
                                        )}
